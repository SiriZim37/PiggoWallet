package com.example.piggywallet.common.dialog
...
import com.example.piggywallet.common.base.BaseDialogFragment
import kotlinx.android.synthetic.main.fragment_dialog_inoutcome_items.*

class InOutcomeitemsDialog : BaseDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_dialog_inoutcome_items, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance() = InOutcomeitemsDialog()
